...
theorem that the Einstein moduli space itself has a log-semi-analytic structure. We therefore prove that $\mathbf{\Phi}$ is log-analytic. From this we 
